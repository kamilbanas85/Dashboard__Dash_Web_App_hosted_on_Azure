...
def Download_Process_And_Save_Data(Authenication: str = 'trusted-azure',\
   ...
   # Save Data To Futher File
   if SaveData:
       Demand_Electricity_Texas.reset_index().to_feather(FolderWithData+'Demand_Electricity_Texas.ftr')
